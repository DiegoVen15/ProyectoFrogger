	...
	void settings::save() {
		...
		if (setFile.is_open()) {
			...
			setFile << "[UserData]\n" << "HIGHSCORE: " << ud->highScore << "\n"
				<< "HIGHSORE_LEVEL: " << ud->highScore_level << "\n";
		}
		setFile.close();
	}
